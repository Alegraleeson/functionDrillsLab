...
let nameGreeting = nameCheck('Alegra')
...
function theEliminator(contestants, loser) {
  for(i=0; i<= contestants.length-1; i++) {
    // for(n=0; n<= contestants.length-1; n++) {
      if (contestants[i].includes(loser) === true) {
...
console.log(emailCheck('wingmonkeeyahoo.com'))
...
function buyFrogs(gold) {
    amountFrogs = gold/frogCost
    console.log(amountFrogs)
}

totalFrogs = buyFrogs(100)
...
function buyFrogs2(gold) {
    amountFrogs = gold/frogCost
    amountFrogs = parseInt(amountFrogs)
    console.log(amountFrogs)
}

totalFrogs2 = buyFrogs2(100)
...
function isArrayAscending(array) {
  let isTrue = true
  for(i=0; i<= array.length-1; i++){
    if((array[i] === array.sort()[i]) === false) {
      isTrue = false
    } 
...
// let temp = sampleArray.sort()

// console.log(temp)
// console.log(temp[0] === sampleArray[0])
